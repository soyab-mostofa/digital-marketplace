...
const Page = () => {
  const {
    ...
    resolver: zodResolver(AuthCredentialsValitator),
  });
        ...
        <div className="grid gap-6">
          ...
          <div className="relative">
            <div className="flex items-center inset-0 absolute">
              <span aria-hidden className="w-full border-t" />
            </div>
            <div className="relative flex text-xs uppercase justify-center">
