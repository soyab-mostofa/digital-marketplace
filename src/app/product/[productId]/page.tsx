  ...
  return (
    <MaxWidthWrapper className="bg-white">
        ...
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          ...
          <div className="lg:max-w-lg lg:self-end">
            ...
            <section className="mt-4">
              <div className="flex items-center">
                ...
                <div className="ml-4 border-l pl-4 text-muted-foreground border-gray-900">
                  {label}
                </div>
              </div>
          ...
          <div className="mt-10 lg:col-start-2 lg:row-span-2 lg:mt-0 lg:self-center">
            <div className="aspect-square rounded-lg">
              <ImageSlider url={validUrl} />
            </div>
          </div>

          {/* Add to cart part */}
          <div className="mt-10 lg:col-start-1 lg:row-start-2-2 lg:max-w-lg lg:self-start">
            <div>
              <div className="mt-10">
      ...
      <ProductReel
        ...
        title={`Similer ${label}`}
        subtitle={`Browse similer ${label} just like '${product.name}'`}
      />
    </MaxWidthWrapper>
  );
};
