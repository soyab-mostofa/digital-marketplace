...
var yourOwnedAndPurchased = function (_a) {
    var req = _a.req;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFileIds, orders, purchasedProductIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    purchasedProductIds = orders
                        ...
                        return order.products.map(function (product) {
                            if (typeof product === "string")
                                return req.payload.logger.error("Search depth insufficient to find purchased IDs");
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFileIds, true), purchasedProductIds, true),
                            },
                        }];
            }
        });
