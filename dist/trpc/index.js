...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, limit, sort, queryProperties, payload, parsedQueryOpts, page, _b, items, hasNextPage, nextPage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        query = input.query, cursor = input.cursor;
                        limit = query.limit, sort = query.sort, queryProperties = __rest(query, ["limit", "sort"]);
                        return [4 /*yield*/, (0, get_payload_1.getPayloadClient)()];
                    case 1:
                        payload = _c.sent();
                        parsedQueryOpts = {};
                        Object.entries(queryProperties).forEach(function (_a) {
                        ...
                        return [4 /*yield*/, payload.find({
                                collection: "products",
                                where: __assign({ approvedForSale: { equals: "approved" } }, parsedQueryOpts),
                                sort: sort,
                                limit: limit,
                                depth: 1,
                                page: page,
